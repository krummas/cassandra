...
public class CfDef implements org.apache.thrift.TBase<CfDef, CfDef._Fields>, java.io.Serializable, Cloneable, Comparable<CfDef> {
  ...
  private static final org.apache.thrift.protocol.TField ONLY_PURGE_REPAIRED_TOMBSTONES_FIELD_DESC = new org.apache.thrift.protocol.TField("only_purge_repaired_tombstones", org.apache.thrift.protocol.TType.BOOL, (short)47);
  ...
  public boolean only_purge_repaired_tombstones; // optional
  /**
   * @deprecated
   */
  ...
  public enum _Fields implements org.apache.thrift.TFieldIdEnum {
    ...
    ONLY_PURGE_REPAIRED_TOMBSTONES((short)47, "only_purge_repaired_tombstones"),
    /**
     * @deprecated
     */
    ...
    public static _Fields findByThriftId(int fieldId) {
      switch(fieldId) {
        ...
        case 47: // ONLY_PURGE_REPAIRED_TOMBSTONES
          return ONLY_PURGE_REPAIRED_TOMBSTONES;
  ...
  private static final int __ONLY_PURGE_REPAIRED_TOMBSTONES_ISSET_ID = 11;
  ...
  static {
    ...
    tmpMap.put(_Fields.MAX_INDEX_INTERVAL, new org.apache.thrift.meta_data.FieldMetaData("max_index_interval", org.apache.thrift.TFieldRequirementType.OPTIONAL, 
        new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.I32)));
    tmpMap.put(_Fields.ONLY_PURGE_REPAIRED_TOMBSTONES, new org.apache.thrift.meta_data.FieldMetaData("only_purge_repaired_tombstones", org.apache.thrift.TFieldRequirementType.OPTIONAL, 
  ...
  public CfDef() {
    ...
    this.only_purge_repaired_tombstones = false;
...
;
    ...
    this.only_purge_repaired_tombstones = other.only_purge_repaired_tombstones;
  ...
  public boolean isOnly_purge_repaired_tombstones() {
    return this.only_purge_repaired_tombstones;
  }

  public CfDef setOnly_purge_repaired_tombstones(boolean only_purge_repaired_tombstones) {
    this.only_purge_repaired_tombstones = only_purge_repaired_tombstones;
    setOnly_purge_repaired_tombstonesIsSet(true);
    return this;
  }

  public void unsetOnly_purge_repaired_tombstones() {
    __isset_bitfield = EncodingUtils.clearBit(__isset_bitfield, __ONLY_PURGE_REPAIRED_TOMBSTONES_ISSET_ID);
  }

  /** Returns true if field only_purge_repaired_tombstones is set (has been assigned a value) and false otherwise */
  public boolean isSetOnly_purge_repaired_tombstones() {
    return EncodingUtils.testBit(__isset_bitfield, __ONLY_PURGE_REPAIRED_TOMBSTONES_ISSET_ID);
  }

  public void setOnly_purge_repaired_tombstonesIsSet(boolean value) {
    __isset_bitfield = EncodingUtils.setBit(__isset_bitfield, __ONLY_PURGE_REPAIRED_TOMBSTONES_ISSET_ID, value);
  }
  ...
  public void setFieldValue(_Fields field, Object value) {
    ...
    case ONLY_PURGE_REPAIRED_TOMBSTONES:
      if (value == null) {
        unsetOnly_purge_repaired_tombstones();
      } else {
        setOnly_purge_repaired_tombstones((Boolean)value);
      }
      break;
  ...
  public Object getFieldValue(_Fields field) {
    ...
    case ONLY_PURGE_REPAIRED_TOMBSTONES:
      return Boolean.valueOf(isOnly_purge_repaired_tombstones());
  ...
  public boolean isSet(_Fields field) {
    ...
    case ONLY_PURGE_REPAIRED_TOMBSTONES:
      return isSetOnly_purge_repaired_tombstones();
    case ROW_CACHE_SIZE:
  ...
  public boolean equals(CfDef that) {
    ...
    boolean this_present_only_purge_repaired_tombstones = true && this.isSetOnly_purge_repaired_tombstones();
    boolean that_present_only_purge_repaired_tombstones = true && that.isSetOnly_purge_repaired_tombstones();
    if (this_present_only_purge_repaired_tombstones || that_present_only_purge_repaired_tombstones) {
      if (!(this_present_only_purge_repaired_tombstones && that_present_only_purge_repaired_tombstones))
        return false;
      if (this.only_purge_repaired_tombstones != that.only_purge_repaired_tombstones)
        return false;
    }
  ...
  public int hashCode() {
    ...
    boolean present_only_purge_repaired_tombstones = true && (isSetOnly_purge_repaired_tombstones());
    builder.append(present_only_purge_repaired_tombstones);
    if (present_only_purge_repaired_tombstones)
      builder.append(only_purge_repaired_tombstones);
  ...
  public int compareTo(CfDef other) {
    ...
    lastComparison = Boolean.valueOf(isSetOnly_purge_repaired_tombstones()).compareTo(other.isSetOnly_purge_repaired_tombstones());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetOnly_purge_repaired_tombstones()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.only_purge_repaired_tombstones, other.only_purge_repaired_tombstones);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
  ...
  public String toString() {
    ...
    if (isSetOnly_purge_repaired_tombstones()) {
      if (!first) sb.append(", ");
      sb.append("only_purge_repaired_tombstones:");
      sb.append(this.only_purge_repaired_tombstones);
      first = false;
    }
    if (isSetRow_cache_size()) {
      if (!first) sb.append(", ");
  ...
  private static class CfDefStandardScheme extends StandardScheme<CfDef> {
        ...
        switch (schemeField.id) {
          ...
          case 47: // ONLY_PURGE_REPAIRED_TOMBSTONES
            if (schemeField.type == org.apache.thrift.protocol.TType.BOOL) {
              struct.only_purge_repaired_tombstones = iprot.readBool();
              struct.setOnly_purge_repaired_tombstonesIsSet(true);
            } else { 
              org.apache.thrift.protocol.TProtocolUtil.skip(iprot, schemeField.type);
            }
            break;
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, CfDef struct) throws org.apache.thrift.TException {
      ...
      if (struct.isSetOnly_purge_repaired_tombstones()) {
        oprot.writeFieldBegin(ONLY_PURGE_REPAIRED_TOMBSTONES_FIELD_DESC);
        oprot.writeBool(struct.only_purge_repaired_tombstones);
        oprot.writeFieldEnd();
      }
