...
public class SSTableMetadataViewer
{
    ...
    {
        this(true, true, 0, System.out);
    }

    public SSTableMetadataViewer(boolean color, boolean unicode, int gc, PrintStream out)
    {
        this.color = color;
    ...
    public static void main(String[] args) throws IOException
    {
        ...
        SSTableMetadataViewer metawriter = new SSTableMetadataViewer(enabledColors, enabledUnicode, gc, System.out);
