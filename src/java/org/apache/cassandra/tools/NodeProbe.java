...
public class NodeProbe implements AutoCloseable
{
    ...
    {
        return ssProxy.verify(extendedVerify, checkVersion, noDFP, keyspaceName, tableNames);
    }
    ...
    public void verify(PrintStream out, boolean extendedVerify, boolean checkVersion, boolean noDFP, String keyspaceName, String... tableNames) throws IOException, ExecutionException, InterruptedException
    {
        switch (verify(extendedVerify, checkVersion, noDFP, keyspaceName, tableNames))
        {
            case 1:
                failed = true;
