...
public class NodeProbe implements AutoCloseable
{
    ...
    public void forceKeyspaceCompactionForTokenRange(String keyspaceName, final String startToken, final String endToken, String... tableNames) throws IOException
    {
