...
public class NodeProbe implements AutoCloseable
{
    ...
    {
        return ssProxy.verify(extendedVerify, checkVersion, noDFP, noRSC, keyspaceName, tableNames);
    }
    ...
    public void verify(PrintStream out, boolean extendedVerify, boolean checkVersion, boolean noDFP, boolean noRSC, String keyspaceName, String... tableNames) throws IOException, ExecutionException, InterruptedException
    {
        switch (verify(extendedVerify, checkVersion, noDFP, noRSC, keyspaceName, tableNames))
        {
            case 1:
                failed = true;
