...
public final class HintsService implements HintsServiceMBean
{
    ...
    /**
     * Stream all local hints to the hostId supplied by hostIdSupplier
     *
     ...
     * and retry delivering any remaining hints there. We retry at most
     * HintsDispatchExecutor.MAX_DECOMMISSION_STREAM_RETRIES times and do some basic exponential back off
     * between retries.
     *
     ...
     *         log message
     */
    public Future streamHintsToHost(Supplier<UUID> hostIdSupplier)
    {
        ...
        return dispatchExecutor.dispatchSerially(catalog, hostIdSupplier);
    }
}
