...
public class RetrySpec
{
    ...
    // TODO (api): These are really only useful if type=Expoential, but we don't have dynamic deserialization so can not really split into a type specific parser atm...
