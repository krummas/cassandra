...
public class RangeStreamer
{
    ...
    public void addRanges(String keyspaceName, ReplicaCollection<?> replicas)
    {
        ...
        //transient replicas.
        if (DatabaseDescriptor.getNumTokens() > 1 || useStrictSource || strat == null || strat.getReplicationFactor().allReplicas == 1 || strat.getReplicationFactor().hasTransientReplicas())
        {
