...
{
    private static boolean disabledForTests = false;
    ...
    private static long calculateOpenInterval(boolean shouldOpenEarly)
    {
        ...
        if (disabledForTests || !shouldOpenEarly || interval < 0)
    ...
    {
        boolean originalVal = disabledForTests;
        disabledForTests = true;
        return originalVal;
    }
    @VisibleForTesting
    public static void enableEarlyOpeningForTests()
    {
