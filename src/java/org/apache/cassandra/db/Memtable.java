...
public class Memtable
{
    ...
    public static final DataAllocator.DataPool dataPool = DatabaseDescriptor.getMemtableAllocatorPool();
    ...
    public Iterator<Map.Entry<DecoratedKey, ? extends ColumnFamily>> getEntryIterator(final boolean copyToHeap, final RowPosition startWith, final RowPosition stopAt)
    {
        ...
        {
            private Iterator<? extends Map.Entry<? extends RowPosition, ? extends ColumnFamily>> iter = stopAt.isMinimum(cfs.partitioner)
            ...
            public Map.Entry<DecoratedKey, ? extends ColumnFamily> next()
            {
                ...
                return (Map.Entry<DecoratedKey, ? extends ColumnFamily>) entry;
            }
