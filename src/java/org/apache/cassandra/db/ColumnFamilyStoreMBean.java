...
public interface ColumnFamilyStoreMBean
{
     ...
     */
    public void setLocalCompactionStrategyString(String options);
    public String getLocalCompactionStrategyString();
    ...
    /**
     * Get the globally configured compaction strategy
     *
     * Note that this can be overridden by setLocalCompactionStrategy(...)
     */
    public Map<String, String> getCompactionStrategy();
    /**
