...
final class LogRecord
{
    ...
    public static Map<String, List<File>> getExistingFiles(Set<String> absoluteFilePaths)
    {
        ...
        FilenameFilter ff = (dir, name) -> {
            ...
            if (descriptor != null && absoluteFilePaths.contains(absolutePath(descriptor.baseFilename())))
                fileMap.computeIfAbsent(absolutePath(descriptor.baseFilename()), k -> new ArrayList<>()).add(new File(dir, name));
