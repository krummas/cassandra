...
public class CompactionStrategyManager implements INotificationConsumer
{
    ...
    {
        // it is assumed that all originals have the same repaired-status - getting the strategy for the first one is enough
        return getCompactionStrategyFor(Iterables.getFirst(txn.originals(), null)).getCompactionTask(txn, gcBefore, maxSSTableBytes);
    }
