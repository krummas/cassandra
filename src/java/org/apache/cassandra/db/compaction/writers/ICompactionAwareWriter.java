...
public interface ICompactionAwareWriter extends Transactional
{
    /**
    ...
    Collection<SSTableReader> finish();

    long estimatedKeys();

    Directories.DataDirectory getWriteDirectory(long expectedWriteSize);
}
