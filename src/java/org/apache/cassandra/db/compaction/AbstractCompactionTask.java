...
public abstract class AbstractCompactionTask extends WrappedRunnable
{
    ...
    public abstract ICompactionAwareWriter getCompactionAwareWriter(ColumnFamilyStore cfs, Directories directories, LifecycleTransaction txn, Set<SSTableReader> nonExpiredSSTables);
