...
public class Upgrader
{
    ...
    public void upgrade(boolean keepOriginals)
    {
        ...
        try (SSTableRewriter writer = SSTableRewriter.constructKeepingOriginals(transaction, keepOriginals, CompactionTask.getMaxDataAge(transaction.originals()), true, true);
