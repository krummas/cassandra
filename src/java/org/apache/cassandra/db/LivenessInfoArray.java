...
public class LivenessInfoArray
{
    ...
    {
        set(i, info.timestamp(), info.ttl(), info.localDeletionTime(), info.isRepaired());
    }

    public void set(int i, long timestamp, int ttl, int localDeletionTime, boolean isRepaired)
    {
