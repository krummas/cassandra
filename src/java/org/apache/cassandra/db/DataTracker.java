...
public class DataTracker
{
    ...
    public void maybeIncrementallyBackup(final Collection<SSTableReader> sstables)
    {
    ...
    public void notifyAdded(Collection<SSTableReader> newSSTables)
    {
        for (SSTableReader added : newSSTables)
        {
    ...
    public static class View
    {
        ...
        View replaceFlushed(Memtable flushedMemtable, Collection<SSTableReader> newSSTables)
        {
            ...
            List<Memtable> newQueuedMemtables = ImmutableList.<Memtable>builder()
                                                             ...
                                                             .build();
            Set<SSTableReader> sstablesCopy = newSSTables == null
                                             ? sstables
                                             : newSSTables(Collections.<SSTableReader>emptyList(), newSSTables);
            SSTableIntervalTree intervalTree = buildIntervalTree(newSSTables);
            return new View(liveMemtables, newQueuedMemtables, sstablesCopy, compacting, intervalTree);
        }
