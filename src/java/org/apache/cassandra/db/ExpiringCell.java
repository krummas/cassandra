...
public class ExpiringCell extends Cell
{
    ...
    private static final long EMPTY_SIZE = ObjectSizes.measure(new ExpiringCell(CellNames.simpleDense(ByteBuffer.allocate(1)), ByteBufferUtil.EMPTY_BYTE_BUFFER, 1, 1));
