...
//      ReplicaCollection<?> result = Replicas.filter(list, replica -> replica.endpoint().equals(FBUtilities.getLocalAddressAndPort()));
...
//         try
//         {
//             EndpointsForRange.concat(ReplicaList.of(), ReplicaList.of(C));
//         }
//         catch (UnsupportedOperationException e)
//         {
//             threw = true;
...
//        try
//        {
//            EndpointsForRange.concat(ReplicaList.of(C), ReplicaList.of());
//        }
//        catch (UnsupportedOperationException e)
//        {
//            threw = true;
...
//        assertTrue(threw);
//
//        ReplicaCollection<?> result = EndpointsForRange.concat(ReplicaList.of(A), ReplicaList.of(B));
//        assertEquals(2, result.size());
//        Iterator<Replica> i = result.iterator();
//        assertEquals(A, i.next());
//        assertEquals(B, i.next());
...
//    {
//        EndpointsForRange.concat(null, Replicas.empty());
//    }
//
//    @Test(expected = NullPointerException.class)
//    public void testConcatNaturalAndPendingNullB() throws Exception
//    {
//        EndpointsForRange.concat( Replicas.empty(), null);
//    }
//
//    @Test
...
//        assertEquals(A.endpoint().getHostAddress(true), result.get(0));
//        result = Replicas.stringify(Replicas.of(A), false);
//        assertEquals(result.size(), 1);
//        assertEquals(A.endpoint().getHostAddress(false), result.get(0));
//    }
//}
