...
//        set.addAll(ImmutableList.of(A, B, Replica.trans(B.endpoint(), B.range()), C));
//        set.removeEndpoint(B.endpoint());
...
//        list.addAll(ImmutableList.of(A, B, C));
//        assertTrue(list.containsEndpoint(B.endpoint()));
//        assertTrue(list.containsEndpoint(A.endpoint()));
//        assertTrue(list.containsEndpoint(C.endpoint()));
...
//    {
//       ReplicaList dummies = ReplicaList.toDummyList(ImmutableList.of(A.range(), B.range(), C.range()));
//       List<Range<Token>> ranges = Lists.newArrayList(A.range(), B.range(), C.range());
//       for (Replica r : dummies)
//       {
//           assertEquals("0.0.0.0:0", r.endpoint().getHostAddress(true));
//           assertEquals(ranges.remove(0), r.range());
//       }
//    }
//}
