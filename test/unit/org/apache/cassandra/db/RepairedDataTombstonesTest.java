...
public class RepairedDataTombstonesTest extends CQLTester
{
    ...
    public void readTest() throws Throwable
    {
        ...
        flush();
        for (SSTableReader sstable : getCurrentColumnFamilyStore().getSSTables(SSTableSet.LIVE))
            System.out.println((sstable.isRepaired() ? "REPAIRED" : "UNREPAIRED") + " SSTABLE MIN LOCAL DEL TIME = " + sstable.getMinLocalDeletionTime());
