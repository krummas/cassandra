...
public class RowTest
{
    ...
    {
        PartitionUpdate.Builder update1 = new PartitionUpdate.Builder(cfm, dk, cfm.partitionColumns(), 1);
        ...
        PartitionUpdate.Builder update2 = new PartitionUpdate.Builder(cfm, dk, cfm.partitionColumns(), 1);
