...
public class EntireSSTableStreamConcurrentComponentMutationTest
{
    ...
    public static void defineSchemaAndPrepareSSTable()
    {
        ...
        Gossiper.instance.initializeNodeUnsafe(FBUtilities.getBroadcastAddressAndPort(), UUIDGen.getTimeUUID(), 1);
        Gossiper.instance.injectApplicationState(FBUtilities.getBroadcastAddressAndPort(), ApplicationState.RELEASE_VERSION, VersionedValue.unsafeMakeVersionedValue("4.0.2", 1));
