...
public class ColumnFamilyStoreTest extends SchemaLoader
{
    ...
    public void testBackupAfterFlush() throws Throwable
    {
        ...
        {
            Descriptor existing = new Descriptor(cfs.directories.getDirectoryForCompactedSSTables()[0], "Keyspace2", "Standard1", version, false);
    ...
    public void testRemoveUnfinishedCompactionLeftovers() throws Throwable
    {
        ...
        // 1st sstable
        SSTableSimpleWriter writer = new SSTableSimpleWriter(dir.getDirectoryForCompactedSSTables()[0], cfmeta, StorageService.getPartitioner());
        writer.newRow(key);
        ...
        writer = new SSTableSimpleWriter(dir.getDirectoryForCompactedSSTables()[0],
                                         cfmeta, StorageService.getPartitioner())
        {
            protected SSTableWriterInterface getWriter()
            {
    ...
    public void testFailedToRemoveUnfinishedCompactionLeftovers() throws Throwable
    {
        ...
        SSTableSimpleWriter writer = new SSTableSimpleWriter(dir.getDirectoryForCompactedSSTables()[0],
                                                cfmeta, StorageService.getPartitioner())
        {
            protected SSTableWriterInterface getWriter()
            {
