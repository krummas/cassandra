...
public class AntiCompactionBytemanTest extends CQLTester
{
    ...
    @BMRules(rules = { @BMRule(name = "Insert delay after first prepareToCommit",
             ...
             action = "flag(\"done\"); Thread.sleep(2000);") } )
    public void testRedundantTransitions() throws Throwable
    {
        ...
        RangesAtEndpoint ranges = new RangesAtEndpoint.Builder(FBUtilities.getBroadcastAddressAndPort()).add(Replica.fullReplica(FBUtilities.getBroadcastAddressAndPort(), toRepair)).build();
