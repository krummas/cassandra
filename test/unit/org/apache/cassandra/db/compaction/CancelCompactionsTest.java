...
public class CancelCompactionsTest extends CQLTester
{
    ...
    public void testAnticompaction() throws InterruptedException, ExecutionException
    {
        ...
        try
        {
            ...
            ActiveRepairService.instance.registerParentRepairSession(prsid, InetAddressAndPort.getLocalHost(), Collections.singletonList(cfs), Collections.singleton(range), true, 1, true, PreviewKind.NONE, RepairParallelism.PARALLEL);
