...
public class LeveledCompactionStrategyTest
{
    ...
    public void testGrouperLevels() throws Exception{
        ...
        assert strategyManager.getSSTableCountPerLevel()[1] > 0;
        assert strategyManager.getSSTableCountPerLevel()[2] > 0;
...
//        Collection<SSTableReader> sstables = strategyManager.manifest.getLevel(1);
//        List<ICompactionScanner> scanners = strategyManager.getScanners(sstables).scanners;
