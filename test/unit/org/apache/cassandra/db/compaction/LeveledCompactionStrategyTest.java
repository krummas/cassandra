...
public class LeveledCompactionStrategyTest
{
    ...
    public void testTokenRangeCompaction() throws Exception
    {
        ...
        Collection<Range<Token>> wrappingRanges = new ArrayList<>(Collections.singletonList(wrappingRange));
        cfs.forceCompactionForTokenRange(wrappingRanges);

        while(CompactionManager.instance.isCompacting(Collections.singletonList(cfs)))
        {
            Thread.sleep(100);
        }
