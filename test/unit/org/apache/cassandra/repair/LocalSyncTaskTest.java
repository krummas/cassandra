...
public class LocalSyncTaskTest extends AbstractRepairTest
{
    ...
    public void testNoDifference() throws Throwable
    {
        ...
        LocalSyncTask task = new LocalSyncTask(desc, r1, r2, ActiveRepairService.NO_PENDING_REPAIR, false, PreviewKind.NONE, Collections.emptySet(), false);
        task.run();
    ...
    public void fullRepairStreamPlan() throws Exception
    {
        ...
        LocalSyncTask task = new LocalSyncTask(desc, r1, r2, NO_PENDING_REPAIR, false, PreviewKind.NONE, Collections.emptySet(), false);
        StreamPlan plan = task.createStreamPlan(FBUtilities.getBroadcastAddress(), PARTICIPANT1, PARTICIPANT2, Lists.newArrayList(RANGE1));
    ...
    public void incrementalRepairStreamPlan() throws Exception
    {
        ...
        LocalSyncTask task = new LocalSyncTask(desc, r1, r2, desc.parentSessionId, false, PreviewKind.NONE, Collections.emptySet(), false);
        StreamPlan plan = task.createStreamPlan(FBUtilities.getBroadcastAddress(),PARTICIPANT1, PARTICIPANT2, Lists.newArrayList(RANGE1));
