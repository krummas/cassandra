...
public class SSTableWriterTestBase extends SchemaLoader
{
    ...
    public static SSTableWriter getWriter(ColumnFamilyStore cfs, File directory, LifecycleTransaction txn)
    {
        ...
        return SSTableWriter.create(filename, 0, 0, null, new SerializationHeader(true, cfs.metadata, cfs.metadata.partitionColumns(), EncodingStats.NO_STATS), cfs.indexManager.listIndexes(), txn);
    }
