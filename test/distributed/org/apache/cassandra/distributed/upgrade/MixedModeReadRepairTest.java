...
public class MixedModeReadRepairTest extends UpgradeTestBase
{
    ...
    public void mixedModeReadRepairCompactStorage() throws Throwable
    {
        ...
        .runAfterClusterUpgrade((cluster) -> {
            ...
            // make sure 2.2 side does not get the mutation either directly or via HH
            cluster.get(1).shutdown();
            cluster.get(2).disableHandoff();
            cluster.coordinator(2).execute("DELETE FROM " + DistributedTestBase.KEYSPACE + ".tbl WHERE pk = ?",
